...
import userList from '../../src/models/groupList';
...
describe('PostItAllUsersStore ', () => {
  ...
  beforeEach(() => {
    jest.resetModules();
    Action = require('../../src/actions/getAllUsersAction'); // eslint-disable-line
    PostItAllUsersStore = require('../../src/stores/AllUsersStore').default; // eslint-disable-line
